...
" Blue     4 DarkBlue     #4F92D1  Structure   |  Blue     12 Blue      #0000FF  Keyword
...
hi StatusLineNC                     guifg=#999999   guibg=#445588 gui=NONE      ctermfg=Grey         ctermbg=Blue     cterm=NONE
...
hi IncSearch                        guifg=NONE      guibg=#3D9C00 gui=NONE      ctermfg=NONE         ctermbg=DarkGreen cterm=NONE
hi Search                           guifg=NONE      guibg=#333333 gui=NONE      ctermfg=NONE         ctermbg=Cyan     cterm=NONE
hi Directory                        guifg=#4F92D1   guibg=NONE    gui=NONE      ctermfg=DarkBlue     ctermbg=NONE     cterm=bold
...
hi Conditional                      guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
hi Constant                         guifg=#CB0000   guibg=NONE  gui=NONE        ctermfg=Red          ctermbg=NONE     cterm=NONE
hi Define                           guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
...
hi Keyword                          guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
hi Label                            guifg=#FF9600   guibg=NONE  gui=NONE        ctermfg=Yellow       ctermbg=NONE     cterm=NONE
hi Macro                            guifg=#4F92D1   guibg=NONE  gui=italic      ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
hi Number                           guifg=#999999   guibg=NONE  gui=NONE        ctermfg=Grey         ctermbg=NONE     cterm=NONE
hi Operator                         guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
...
hi Repeat                           guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
hi Special                          guifg=#FFFFFF   guibg=NONE  gui=italic      ctermfg=White        ctermbg=NONE     cterm=NONE
hi SpecialChar                      guifg=#DDDDDD   guibg=NONE  gui=NONE        ctermfg=White        ctermbg=NONE     cterm=NONE
hi SpecialComment                   guifg=#C52696   guibg=NONE  gui=NONE        ctermfg=DarkMagenta  ctermbg=NONE     cterm=NONE
hi Statement                        guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
hi StorageClass                     guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
...
hi Tag                              guifg=#4F92D1   guibg=NONE  gui=NONE        ctermfg=DarkBlue     ctermbg=NONE     cterm=NONE
...
hi yamlDocumentHeader               guifg=#4F92D1   guibg=NONE  gui=italic      ctermfg=DarkBlue     ctermbg=NONE   cterm=NONE
